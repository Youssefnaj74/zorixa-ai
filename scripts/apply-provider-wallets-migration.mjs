/**
 * Apply provider_wallets migration to Supabase Postgres.
 * Requires SUPABASE_DB_URL (Project Settings → Database → Connection string URI).
 *
 * Run: node scripts/apply-provider-wallets-migration.mjs
 */
import fs from "fs";
...
const migrationPath = path.join(
  root,
  "supabase/migrations/20260701120000_provider_wallets.sql"
);
...
await client.end();
console.log("Provider wallets migration applied successfully.");
`;
